...
- Correctness evaluator target. Keep **Run on** set to **Experiments** if you want the score to show up on the run rows and in run comparison.
- Have learners switch **Run on** from the default **Observations** to **Experiments** before they configure anything else.
