...
| --- | --- |
| [00 Setup](./learner/00-setup.md) | *no checkpoint — start from main* |
...
Each `checkpoint/0X-…` tag represents the **starting state of that lesson** — i.e. the code you'd have if you'd finished every previous module. See [`./checkpoints.md`](./checkpoints.md) for the full convention.
